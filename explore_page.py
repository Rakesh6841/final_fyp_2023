...
def show_explore_page():
    ...
    st.subheader("Visualize the most commonly used words.")

    # Display dropdown menu to select column
    columns = ['Caption', 'Username']
    option = st.sidebar.selectbox(
        'Which column would you like to use for the word cloud?',
        columns
    )

    # Display word cloud based on user selection
    WordCloudPlotter(option)
